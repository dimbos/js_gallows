window.addEventListener('DOMContentLoaded', function() {
  ...
  let categories,         // массив с темами
      ...
      word,              // слово
      geusses = [ ],      // массив с попытками
      lives,             // жизни
      counter,           // кол-во угаданных букв
      space;              // Количество  '-'
    ...
    function selectCat() {
      if (chosenCategory === categories[0]) {
        ...
        catagoryName.innerHTML = "Выбранная категория: Фильмы";
    ...
    // Проверяем буквы и показываем их
    function check() {
    ...
    function play(){
      categories = [
        //страны
        ['уругвай', 'австралия', 'бразилия', 'испания', 'америка', 'япония'],
        //фильмы
        ["чужой", "терминатор", "гладиатор", "в-поисках-немо", "челюсти"],
        //деревья 
        ['осина', 'липа', 'береза', 'лох серебристый', 'лиственница', 'баобаб']
      ];
